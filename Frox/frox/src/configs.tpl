...
#
  ...
  Listeners       INT      listeners    - FALSE TRUE  -
  ListenIPv4      ADDRESS  listen4      - TRUE TRUE -
  ListenIPv6      ADDRESS6  listen6      - TRUE FALSE -
  ...
  FTPProxy        ADDRESS ftpproxy     - TRUE  FALSE -
  ...
  ActiveLocalPorts PRTRNGE  actvlocalports    - TRUE  FALSE 20-21
  ...
  NTPAddress      ADDRESS  ntpdest      - TRUE  FALSE -
...
ifdef USE_CACHE
  ...
  HTTPProxy       ADDRESS  httpproxy    - TRUE  FALSE -
...
ifdef DO_VSCAN
  ...
  DownFileScanSize          SIZE64  vscan_limitaions[DOWNLOAD].file_size_limit      -   FALSE   FALSE 0 
  DownContinueOnBigFiles    BOOL    vscan_limitaions[DOWNLOAD].continue_on_big_file -   FALSE   FALSE 0 
  UpFileScanSize            SIZE64  vscan_limitaions[UPLOAD].file_size_limit        -   FALSE   FALSE 0 
  UpContinueOnBigFiles      BOOL    vscan_limitaions[UPLOAD].continue_on_big_file   -   FALSE   FALSE 0 
endif
ifdef DO_SSL
