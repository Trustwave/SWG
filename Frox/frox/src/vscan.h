...
static inline int vscan_switchover(void) { return 0; };
static inline int vscan_end(void) { return -1; };
static inline void vscan_abort(void){};
static inline int vscan_parsed_reply(int code, sstr *msg) { return 0; };
#endif

// read flag whether to send server NOOP response to client
