...
static inline void *ssl_initfd(int fd, int type) { return NULL; };
static inline void ssl_shutdown(void **ssl){};
static inline int ssl_append_read(void *s, sstr *b, int len) { return -1; };
static inline int ssl_write(void *s, sstr *b) { return -1; };
static inline int ssl_parsed_reply(int code, sstr *msg) { return 0; };
#endif
